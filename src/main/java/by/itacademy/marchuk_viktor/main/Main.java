...
import by.itacademy.marchuk_viktor.service.Sorting;
...
public class Main{
    public static void main(String[] args){
        ...
        calories.countAutumnSalad(autumnSalads);
        vegetable.findVegetableAutumnSalad(2, 4, autumnSalads);
        ...
        calories.countSpringSalad(springSalad);
        vegetable.findVegetableSpringSalad(3, 6, springSalad);
        sorting.sortByProteins(springSalad);
        ...
        calories.countSummerSalad(summerSalad);
        vegetable.findVegetableSummerSalad(23, 56, summerSalad);
